...
const steps = [
 ...
 ['Planea y confirma','Insights → Programados','Los realizados muestran hoy y los programados abarcan hoy a 30 días. Confirma lo programado cuando ocurra.','Al confirmar puedes ajustar fecha e importe de esa operación sin cambiar la recurrencia. Usa los iconos para editar, duplicar o eliminar.','insights','#content'],
 ...
 ['Explora tus cuentas','Movimientos','Selecciona una tarjeta para ver su historial completo, realizados y programados, y el saldo después de cada operación.','En Insights, la gráfica abarca 30 días. Las tarjetas de crédito muestran crédito disponible, corte y pago.','transactions','.account-buttons'],
