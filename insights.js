import {balance,today,debt} from './finance.js?v=20260912-6';
...
export function duplicateDraft(t,current=today()){
 ...
 return {kind:t.kind,concept:t.concept,category:t.category,business:t.business,notes:t.notes,date:current,from:t.from,to:t.to,amount:t.amount,received:t.received,status:t.status||'pending'};
}
